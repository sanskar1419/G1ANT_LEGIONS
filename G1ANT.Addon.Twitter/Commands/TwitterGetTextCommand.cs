...
{
    [Command(Name = "Twitter.gettext", Tooltip = "This command reads text (a value) of a specified element")]

    public class TwitterGetTextCommand : Command
    {
        ...
        public TwitterGetTextCommand(AbstractScripter scripter) : base(scripter)
        {
        }

...
{
    [Command(Name = "Twitter.alertaction", Tooltip = "Waits for an alert and performs a specified action")]
    public class TwitterAlertActionCommand : Command
    {
        ...
        public TwitterAlertActionCommand(AbstractScripter scripter) : base(scripter)
        {
        }

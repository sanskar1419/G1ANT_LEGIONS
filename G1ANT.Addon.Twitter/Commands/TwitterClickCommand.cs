...
{
    [Command(Name = "Twitter.click", Tooltip = "This command clicks a specified element on an active twitter webpage")]
    public class TwitterClickCommand : Command
    {
        ...
        public TwitterClickCommand(AbstractScripter scripter) : base(scripter)
        {
        }

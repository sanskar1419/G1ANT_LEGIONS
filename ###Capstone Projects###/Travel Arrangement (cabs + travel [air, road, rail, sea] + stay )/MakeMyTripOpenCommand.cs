...
{
    [Command(Name = "makemytrip.open", Tooltip = "This command opens make my trip on web browser ")]
    public class MakeMyTripOpenCommand : Command
    {
        public MakeMyTripOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }

...
{
    [Command(Name = "makemytrip.waitforvalue", Tooltip = "This command waits for a Javascript code to return a specified value")]
    public class MakeMyTripWaitForValueCommand : Command
    {
        ...
        public MakeMyTripWaitForValueCommand(AbstractScripter scripter) : base(scripter)
        {
        }

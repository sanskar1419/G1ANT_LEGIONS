...
{
    [Command(Name = "Goibibo.waitforvalue", Tooltip = "This command waits for a Javascript code to return a specified value")]
    public class GoibiboWaitForValueCommand : Command
    {
        ...
        public GoibiboWaitForValueCommand(AbstractScripter scripter) : base(scripter)
        {
        }

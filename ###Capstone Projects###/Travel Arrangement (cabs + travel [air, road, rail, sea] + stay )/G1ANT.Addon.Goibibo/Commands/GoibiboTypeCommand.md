...
```G1ANT
Goibibo.type text ⟦text⟧ search ⟦text⟧ by ⟦text⟧ iframesearch ⟦text⟧ iframeby ⟦text⟧
```
...
```G1ANT
Goibibo.open chrome url duckduckgo.com
Goibibo.type ‴robotic process automation‴ search search_form_input_homepage by id
Goibibo.click search search_button_homepage by id
delay 3
Goibibo.type ‴ g1ant‴ search search_form_input by id
Goibibo.presskey enter search search_button by id
```

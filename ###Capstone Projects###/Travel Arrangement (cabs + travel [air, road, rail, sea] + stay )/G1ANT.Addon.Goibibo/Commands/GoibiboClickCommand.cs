...
{
    [Command(Name = "Goibibo.click", Tooltip = "This command clicks a specified element on an active webpage")]
    public class GoibiboClickCommand : Command
    {
        ...
        public GoibiboClickCommand(AbstractScripter scripter) : base(scripter)
        {
        }

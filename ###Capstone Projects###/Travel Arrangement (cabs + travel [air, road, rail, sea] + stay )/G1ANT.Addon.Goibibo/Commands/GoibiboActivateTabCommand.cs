...
{
    [Command(Name = "Goibibo.activatetab", Tooltip = "This command activates a browser tab specified by a part of its title or URL address")]
    public class GoibiboActivateTabCommand : Command
    {
        ...
        public GoibiboActivateTabCommand(AbstractScripter scripter) : base(scripter)
        {
        }

# Facebook.activatetab

## Syntax

```G1ANT
Facebook.activatetab search ⟦text⟧ by ⟦text⟧ 
```
...
```G1ANT
Facebook.open firefox url g1ant.com
Facebook.newtab facebook.com
Facebook.newtab google.com
dialog ‴Now let's go back to the first tab‴
Facebook.activatetab search g1ant by url
```

...
{
    [Command(Name = "Twitter.waitforvalue", Tooltip = "This command waits for a Javascript code to return a specified value")]
    public class TwitterWaitForValueCommand : Command
    {
        ...
        public TwitterWaitForValueCommand(AbstractScripter scripter) : base(scripter)
        {
        }
